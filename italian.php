                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="Italian/img/Pizza.jpg" alt="Pizza">
                                </div>
                            </div>
        <div class="col-md-7">
...
?></h4></h2>
    ...
    <script src="Italian/js/vendor/bootstrap.min.js"></script>

    <script src="Italian/js/plugins.js"></script>
    <script src="Italian/js/main.js"></script>
